      ...
      <div className="flex max-h-[92vh] flex-col overflow-hidden rounded-t-3xl border border-stone-200 bg-white shadow-xl sm:rounded-3xl">
        <div className="shrink-0 border-b border-stone-100 px-6 py-4 sm:px-8">
          <div className="flex items-center justify-between gap-3 sm:hidden">
            <p className="min-w-0 truncate text-xs font-semibold tracking-[0.2em] text-[#d4a853] uppercase">
              Edit item
            </p>
            <button
              type="button"
              onClick={onCancel}
              className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full border-2 border-stone-200 bg-white text-stone-500 hover:border-[#1e3a5f]/30 hover:text-[#1e3a5f]"
              aria-label="Close"
            >
              <X className="h-4 w-4" />
            </button>
          ...
          <h2 className="mt-1 font-serif text-xl text-[#1e3a5f] sm:hidden">{item.title}</h2>
        </div>
